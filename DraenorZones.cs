    ...
    public static IEnumerable<int> doSpecialPathing()
    {
        ...
        // FROSTFIRE RIDGE ZONE SPECIAL PATHING!
            ...
            else if (zoneID == 6721 || zoneID == 6885 || zoneID == 7160 || zoneID == 7185)
            {
                ...
                if (Flight.API.Me.Distance2DTo(tangleheart1) < 300)
                {
                    if (Flight.API.Me.Distance2DTo(tangleheart2) > 40)
                    {
                    ...
                    foreach (var unit in Flight.API.GameObjects)
                    {
                        ...
                        {
                            while (Flight.API.Me.Distance2DTo(unit.Position) > 10)
                            {
                                Flight.API.MoveTo(unit.Position);
                                yield return 100;
                                if (Flight.API.Me.Distance2DTo(unit.Position) <= 10)
                                {
                                    Flight.API.MoveToStop();
                                }
                            }
                            yield return 1000;
                            while (Flight.API.Me.Distance2DTo(tangleheart7) > 50)
                            {
                                unit.Interact();
                                yield return 2500;
                            }
            ...
            else if (zoneID == 6755 || zoneID == 7124 || zoneID == 7203 || zoneID == 7204 || zoneID == 7267)
            {
                ...
                if (Flight.API.Me.Distance2DTo(overwatch1) < 15)
                {
                ...
                if (Flight.API.Me.Distance2DTo(overwatch2) < 100)
                {
                ...
                if (Flight.API.Me.Distance2DTo(berserk) < 20)
                {
                ...
                if (Flight.API.Me.Distance2DTo(saber1) < 100 && !(Flight.API.Me.Distance2DTo(saber2) < 50 || Flight.API.Me.Distance2DTo(saber3) < 15 
                || Flight.API.Me.Distance2DTo(saber4) < 30 || Flight.API.Me.Distance2DTo(saber5) < 15 || (Flight.API.Me.Distance2DTo(saber7) < 50 && (Flight.API.Me.Position.Z > 180))))
                {
                ...
                if (Flight.API.Me.Distance2DTo(saber6) < 10)
                {
                ...
                if (Flight.API.Me.Distance2DTo(saber2) < 50 || Flight.API.Me.Distance2DTo(saber3) < 15 || Flight.API.Me.Distance2DTo(saber4) < 30 
                || Flight.API.Me.Distance2DTo(saber5) < 15 || (Flight.API.Me.Distance2DTo(saber7) < 50 && (Flight.API.Me.Position.Z > 180)))
                {
                ...
                if (Flight.API.Me.Distance2DTo(cargo) < 40)
                {
                ...
                if (Flight.API.Me.Distance2DTo(ledge1) < 6)
                {
                ...
                if (Flight.API.Me.Distance2DTo(ledge2) < 15)
                {
                ...
                if (Flight.API.Me.Distance2DTo(SpiteLeaf) < 75)
                {
                ...
                if (Flight.API.Me.Distance2DTo(dirge1) < 50 && !(Flight.API.Me.Distance2DTo(dirge2) < 20))
                {
                ...
                if (Flight.API.Me.Distance2DTo(beard1) < 50)
                {
                ...
                if (Flight.API.Me.Distance2DTo(tower1) < 10)
                {
                    Flight.API.DisableCombat = true;
